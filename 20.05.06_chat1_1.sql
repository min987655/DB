...
alter table UserContent drop column age;
alter table UserContent drop column phonenumber;

alter table room drop column rpassword;
alter table room drop column subject;
alter table room drop column condtionp;
